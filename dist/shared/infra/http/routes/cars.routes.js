...
const uploadImagesCar = (0, _multer.default)(_upload.default);
...
carsRoutes.post("/images/:id", _ensureAuthenticated.ensureAuthenticated, _ensureAdmin.ensureAdmin, uploadImagesCar.array("images"), uploadCarImagesController.handle);